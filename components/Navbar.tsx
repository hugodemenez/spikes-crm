...
export default function Navbar({ classname,sm,setOpenSheet }: { classname?: string,sm:boolean,setOpenSheet?:React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    return (
        ...
        >
            <div id="top-elements"
                className="flex flex-col gap-y-3 flex-shrink overflow-y-auto"
            >
                <div className="flex flex-col gap-6">
                    <Image src={"/logo.png"} width={32} height={32} alt={"crm logo"}></Image>
                    <SearchBar></SearchBar>
                </div>
            ...
            <div className="flex flex-col h-fit pt-8">
                <Card className="mb-2 border-[#DEDEE8] bg-gradient-to-b from-white to-[#F8FAFB] rounded-xl">
                    <CardHeader>
